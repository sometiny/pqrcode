...
class QRSpec {
    ...
    public static function QRStringSet(&$srctab, $x, $y, $repl, $replLen = false) {
    ...
    public static function putAlignmentMarker(array &$frame, $ox, $oy)
    {
        ...
        for($y=0; $y<5; $y++) {
            QRSpec::QRStringSet($frame, $xStart, $yStart+$y, $finder[$y]);
        }
    }
    ...
    public static function putFinderPattern(&$frame, $ox, $oy)
    {
        ...
        for($y=0; $y<7; $y++) {
            QRSpec::QRStringSet($frame, $ox, $oy+$y, $finder[$y]);
        }
    }
    ...
    public static function createFrame($version)
    {
        ...
        QRSpec::QRStringSet($frame, 0, 7, $setPattern);
        QRSpec::QRStringSet($frame, $width-8, 7, $setPattern);
        QRSpec::QRStringSet($frame, 0, $width - 8, $setPattern);

        $setPattern = str_repeat("\x84", 9);
        QRSpec::QRStringSet($frame, 0, 8, $setPattern);
        QRSpec::QRStringSet($frame, $width - 8, 8, $setPattern, 8);
